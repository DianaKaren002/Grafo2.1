...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Button ID="btnInsertarNodo" runat="server" Text="Insertar Nodo" OnClick="btnInsertarNodo_Click" /><br />
            <br />
            ...
            <asp:Button ID="btnInsertarArco" runat="server" Text="Insertar Arco" OnClick="btnInsertarArco_Click" /><br />
            <br />
            ...
            <asp:Button ID="btnDFS" runat="server" Text="Recorrido en Profundidad" OnClick="btnDFS_Click" /><br />
            <br />
            ...
            <asp:Button ID="btnBFS" runat="server" Text="Recorrido en Amplitud" OnClick="btnBFS_Click" /><br />
            <br />
            ...
            <asp:Button ID="btnDijkstra" runat="server" Text="Camino Más Corto" OnClick="btnDijkstra_Click" /><br />
            <br />
